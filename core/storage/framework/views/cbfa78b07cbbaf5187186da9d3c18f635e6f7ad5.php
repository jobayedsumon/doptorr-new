    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.add_country',function(e){
                ...
                if(country == ''){
                    toastr_warning_js("<?php echo e(__('Please enter a country !')); ?>");
                    return false;
                }
            });
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.country.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.country.search')); ?>",
                    method:'GET',
...
<?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/Modules/CountryManage/Resources/views/country/country-js.blade.php ENDPATH**/ ?>