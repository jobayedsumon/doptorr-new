        ...
        <div class="single-shop-left bg-white radius-10">
            <div class="single-shop-left-filter">
                <div class="single-shop-left-filter-flex flex-between">
                    ...
                    <a href="javascript:void(0)" class="single-shop-left-filter-reset" id="subcategory_project_filter_reset"><?php echo e(__('Reset Filter')); ?></a>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/resources/views/frontend/pages/subcategory-projects/sidebar.blade.php ENDPATH**/ ?>