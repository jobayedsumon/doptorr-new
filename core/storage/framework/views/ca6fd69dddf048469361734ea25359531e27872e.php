<?php $__env->startSection('title', __('Email Template Settings')); ?>
            ...
            <div class="col-lg-12">
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <h4 class="customMarkup__single__title"><?php echo e(__('Email Template Settings')); ?></h4>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.general.settings.email.template')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input mb-3">
                                    <label for="site_global_email" class="label-title"><?php echo e(__('Global Email')); ?></label>
                                ...
                                <div class="single-input mb-3">
                                 <label for="site_global_email_template" class="label-title"><?php echo e(__('Email Template')); ?></label>
                                 <div class="summernote-wrapper">
                                     <textarea id="summernote_js"  name="site_global_email_template"  class="form-control"><?php echo e(get_static_option('site_global_email_template')); ?></textarea>
                                 </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/doptorr/public_html/core/Modules/GeneralSettings/Resources/views/email-template-settings.blade.php ENDPATH**/ ?>