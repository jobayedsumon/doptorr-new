<script>
    (function($){
        ...
        $(document).ready(function(){
            ...
            function words(page){
                $.ajax({
                    url:"<?php echo e(route('admin.word.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.word.search')); ?>",
                    method:'GET',
...
<?php /**PATH /home/doptorr/public_html/core/Modules/SecurityManage/Resources/views/backend/word/word-js.blade.php ENDPATH**/ ?>