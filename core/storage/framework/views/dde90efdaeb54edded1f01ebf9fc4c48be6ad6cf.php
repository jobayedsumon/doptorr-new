    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function settings(page){
                $.ajax({
                    url:"<?php echo e(route('admin.project.promote.settings.paginate').'?page='); ?>" + page,
...
<?php /**PATH /home/doptorr/public_html/core/Modules/PromoteFreelancer/Resources/views/backend/project-promote/settings/settings-js.blade.php ENDPATH**/ ?>