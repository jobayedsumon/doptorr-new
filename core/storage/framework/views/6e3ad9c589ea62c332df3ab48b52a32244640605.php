                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="end-contract">
                                ...
                                <div class="end-contract-feedback mt-4">
                                    ...
                                    <p class="end-contract-feedback-para mt-2"><?php echo e(__('Your feedback will be shared to publicly in client profile and client feedback will be shared publicly in your profile.')); ?></p>
                                    <div class="end-contract-feedback-contents mt-4">
                                        ...
                                        <div data-reaction-type="skills" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title"><?php echo e(__('How would you rate')); ?> <?php echo e($find_login_user_order?->user->first_name); ?><?php echo e(__("'s")); ?> <?php echo e(__('skills')); ?> </h4>
                                        ...
                                        <div data-reaction-type="availability" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title"><?php echo e(__('Rate')); ?> <?php echo e($find_login_user_order?->user->first_name); ?><?php echo e(__("'s")); ?> <?php echo e(__('availability')); ?> </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="communication" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title"><?php echo e(__('Rate')); ?> <?php echo e($find_login_user_order?->user->first_name); ?><?php echo e(__("'s")); ?> <?php echo e(__('Communications')); ?> </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="work-quality" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title"><?php echo e(__('Rate')); ?> <?php echo e($find_login_user_order?->user->first_name); ?><?php echo e(__("'s")); ?> <?php echo e(__('Work Quality')); ?> </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="meeting-deadline" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title"><?php echo e(__('Rate')); ?> <?php echo e($find_login_user_order?->user->first_name); ?><?php echo e(__("'s")); ?> <?php echo e(__('Meetings')); ?> </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="co-operations" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title"><?php echo e(__('Rate')); ?> <?php echo e($find_login_user_order?->user->first_name); ?><?php echo e(__("'s")); ?> <?php echo e(__('Co-operations')); ?> </h4>
                                                <div class="btn-wrapper click-skip">
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('frontend.user.freelancer.order.rating.rating-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/doptorr/public_html/core/resources/views/frontend/user/freelancer/order/rating/rating.blade.php ENDPATH**/ ?>