        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#country , #type , #level , #duration', function() {
                ...
                $.ajax({
                    ...
                    method:'GET',
                    data:{country:country,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration,skill:skill},
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                let max_price = $('#max_price').val();
                let duration = $('#duration').val();
                jobs(page,country,skill,type,level,min_price,max_price,duration);
            });
            function jobs(page,country,category,type,level,min_price,max_price,duration){
                $.ajax({
                    ...
                    method:'GET',
                    data:{country:country,skill:skill,type:type,level:level,min_price:min_price,max_price:max_price,duration:duration},
                    success:function(res){
                        if(res.status=='nothing'){
...
<?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/resources/views/frontend/pages/skill-jobs/jobs-filter-js.blade.php ENDPATH**/ ?>