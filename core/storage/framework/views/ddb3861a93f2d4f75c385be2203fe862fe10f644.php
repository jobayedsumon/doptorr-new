                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Add New Admin')); ?></h4>
                            <a class="btn btn-primary btn-md d-flex align-items-center" href="<?php echo e(route('admin.all')); ?>"><?php echo e(__('All Admins')); ?></a>
                        </div>
...
<?php endif; ?>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4 add_skill"><?php echo e(__('Save')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/doptorr/public_html/core/Modules/RolePermission/Resources/views/admin-manage/create-admin.blade.php ENDPATH**/ ?>