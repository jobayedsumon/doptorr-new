                                ...
                                <div class="jobFilter-wrapper-item-inner">
                                    <div class="jobFilter-wrapper-item-top">
                                        <div class="jobFilter-wrapper-item-top-left">
                                            <h4 class="jobFilter-wrapper-item-title"><?php echo e($job_details->title); ?></h4>
                                ...
                                <div class="jobFilter-wrapper-item-bottom">
                                    <ul class="jobFilter-wrapper-item-bottom-list">
                                        ...
                                        <li class="jobFilter-wrapper-item-bottom-list-item"><span class="item-icon">
                                            ...
                                            <span
                                                class="item-para"><?php echo e($job_details->job_creator?->user_verified_status == 1 ? 'Verified' : 'Not Verified'); ?></span>
                                        </li>
                                        <li class="jobFilter-wrapper-item-bottom-list-item">
                                            <span class="item-icon">
                                            ...
                                            <span class="item-para"><?php echo e(ucfirst($job_details->duration) ?? ''); ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<?php endif; ?>
                                            <form action="<?php echo e(route('job.proposal.send')); ?>" method="post"
                                                ...
                                                <div class="single-flex-input">
                                                    ...
                                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.duration.delivery-time','data' => ['class' => 'single-input','title' => __('Delivery Time'),'name' => 'duration','id' => 'duration']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/resources/views/frontend/pages/job-details/job-details.blade.php ENDPATH**/ ?>