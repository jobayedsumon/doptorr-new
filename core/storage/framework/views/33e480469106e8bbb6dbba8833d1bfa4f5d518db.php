                                ...
                                <form action="<?php echo e(route('admin.city.import.database')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <?php $countries = \Modules\CountryManage\Entities\Country::all_countries(); ?>
                                            <td>
                                                <div class="form-group">
                                                ...
                                                <p class="text-info"><?php echo e(__('Select state country ')); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><h6><?php echo e(__('State')); ?></h6></td>
                                            <?php $cities = \Modules\CountryManage\Entities\State::all_states(); ?>
                                            <td>
                                                <div class="form-group">
                                                ...
                                                <p class="text-info"><?php echo e(__('Select cities state')); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-info"><?php echo e(__('Select city and only unique cities added automatically according to the selected country and state.')); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/Modules/CountryManage/Resources/views/city/import-city.blade.php ENDPATH**/ ?>