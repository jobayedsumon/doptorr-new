                                    ...
                                    <div class="testimonial-item">
                                        <div class="single-testimonial bg-white radius-10">
                                            <div class="single-testimonial-top">
                                                <h4 class="single-testimonial-title"> <a href="javascript:void(0)"> <?php echo e(ucfirst($feedback->title)); ?> </a> </h4>
                                            ...
                                            <div class="single-testimonial-author">
                                                <div class="single-testimonial-author-flex d-flex flex-wrap gap-3">
                                                    <div class="single-testimonial-author-thumb">
                                                        <a href="javascript:void(0)">
                                                            <?php if(!empty($feedback?->user?->image)): ?>
                                                                <img src="<?php echo e(asset('assets/uploads/profile/'.$feedback?->user?->image) ?? ''); ?>" alt="profile.img">
                                                            <?php else: ?>
                                                    ...
                                                    <div class="single-testimonial-author-contents flex-fill">
                                                        <h6 class="single-testimonial-author-contents-title"> <a href="javascript:void(0)"><?php echo e($feedback?->user?->fullname); ?></a> </h6>
...
<!-- Guest area end --><?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/app/Providers/../../plugins/PageBuilder/views/testimonial/testimonial-one.blade.php ENDPATH**/ ?>