                        ...
                        <div class="categoryWrap-wrapper-item-top">
                            <div class="categoryWrap-wrapper-item-top-left">
                                <a
                                    ...
                                    <h4 class="single-jobs-title categoryWrap-wrapper-item-title"><?php echo e($job->title); ?>
                    ...
                    <div class="categoryWrap-wrapper-item-bottom">
                        <ul class="categoryWrap-wrapper-item-bottom-list">
                            ...
                            <li class="categoryWrap-wrapper-item-bottom-list-item">
                                ...
                                <span class="item-para"><?php echo e(__('Proposal:')); ?> <?php echo e($job->job_proposals_count); ?></span>
                            </li>
                            <li class="categoryWrap-wrapper-item-bottom-list-item">
                                <span class="item-icon">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                ...
                <div class="notFoundParent categoryWrap-wrapper-item text-center">
                    <div class="notFound-wrapper">
                        <div class="notFoundThumb">
                            <img src="<?php echo e(asset('assets/static/img/no-jobs-projects/no-job.svg')); ?>" alt="">
                        </div>
                        <div class="notFound-contents mt-3">
                            <h4 class="notFoundTitle"><?php echo e(__('No Jobs')); ?></h4>
                            <p class="notFoundPara mt-3"><?php echo e(__("Sorry, We couldn't find any jobs in this category try checking on other categories")); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/resources/views/frontend/pages/subcategory-jobs/search-job-result.blade.php ENDPATH**/ ?>