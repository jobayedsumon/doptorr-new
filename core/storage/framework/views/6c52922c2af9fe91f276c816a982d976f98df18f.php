<?php $__env->startSection('title', __('Assign Permission')); ?>
                ...
                <div class="col-12">
                    <div class="simplePresentCart-one white-bg mb-24">
                        <div class="section-tittle-one d-flex justify-content-between">
                            <h3 class="title"><?php echo e($role->name); ?>: <?php echo e(__("Permissions")); ?></h3>
                            <div class="button-wrapper">
                                <a href="<?php echo e(route('admin.role.create')); ?>" class="btn btn-primary border-style-solid border-main-one"
                                   data-text="All Roles"><span> <?php echo e(__("All Roles")); ?> </span></a>
                            </div>
                        </div>
                        ...
                        <div class="permission-wrap">
                            <form action="<?php echo e(route("admin.role.permission.create",$role->id)); ?>" method="post">
                                                ...
                                                <?php $__currentLoopData = $permission_value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="form-group d-flex justify-content-start gap-3 p-0">
                                                            <div class="vendor-coupon-switch m-0">
                                                                <input <?php if(in_array($permission->id,$rolePermissions)): ?> checked <?php endif; ?> class="permission-switch custom-switch permisssion-switch-<?php echo e($permission->id); ?>" type="checkbox" id="permisssion-switch-<?php echo e($permission->id); ?>" name="permission[]"  value="<?php echo e($permission->id); ?>" />
                                ...
                                <div class="btn-wrapper mt-4">
                                    <button type="submit" class="btn btn-primary"><?php echo e(__("Submit Now")); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1279107.cloudwaysapps.com/hkvzvsqtvn/public_html/core/Modules/RolePermission/Resources/views/roles/permissions.blade.php ENDPATH**/ ?>